...
hokkaido = {
    ...
    "density-sq": f"{hokkaido_density_sq}",
    "area": "83,423.84 km2",
    "area-sq": "32,210.12 sq mi",
    "climate": "Humid continental",
    "local-dish": "Kaisen-Don",
...
aomori = {
    ...
    "density-sq": f"{aomori_density_sq}",
    "area": "9,645.64 km2",
    "area-sq": "3,724.20 sq mi",
...
iwate = {
    ...
    "density-sq": f"{iwate_density_sq}",
    "area": "15,275.01 km2",
    "area-sq": "5,897.71 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Morioka Jajamen",
...
miyagi = {
    ...
    "density-sq": f"{miyagi_density_sq}",
    "area": "7,282.22 km2",
    "area-sq": "2,811.68 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Gyuutan Yaki",
    "industries": ['Fishing', 'Agriculture', 'Electronics', 'Appliances', 'Food Processing'],
    "name-kanji": "宮城県",
    "capital-kanji": "仙台市",
    "iso": "JP-04",
    "area-code": "022"
...
akita = {
    ...
    "density-sq": f"{akita_density_sq}",
    "area": "11,637.52 km2",
    "area-sq": "4,493.27 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Kiritanpo Nabe",
    "industries": ['Agriculture', 'Fishing', 'Forestry'],
    "name-kanji": "秋田県",
    "capital-kanji": "秋田市",
    "iso": "JP-05",
...
yamagata = {
    ...
    "density-sq": f"{yamagata_density_sq}",
    "area": "9,325.15 km2",
    "area-sq": "3,600.46 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Imo Nabe",
...
fukushima = {
    ...
    "density-sq": f"{fukushima_density_sq}",
    "area": "13,783.90 km2",
    "area-sq": "5,321.99 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Kozuyu",
    "industries": ['Fishing', 'Agriculture', 'Electric industry', 'Nuclear power'],
    "name-kanji": "福島県",
    "capital-kanji": "福島市",
    "iso": "JP-07",
    "area-code": "024"
...
ibaraki = {
    ...
    "density-sq": f"{ibaraki_density_sq}",
    "area": "6,097.19 km2",
    "area-sq": "2,354.14 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Ankou Nabe",
...
tochigi = {
    ...
    "density-sq": f"{tochigi_density_sq}",
    "area": "6,408.09 km2",
    "area-sq": "2,474.18 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Gyouza",
...
gunma = {
    ...
    "density-sq": f"{gunma_density_sq}",
    "area": "6,362.28 km2",
    "area-sq": "2,456.49 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Yaki Manjuu",
...
saitama = {
    ...
    "density-sq": f"{saitama_density_sq}",
    "area": "3,797.75 km2",
    "area-sq": "1,466.32 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Hiyajiru Udon",
...
chiba = {
    ...
    "density-sq": f"{chiba_density_sq}",
    "area": "5,157.61 km2",
    "area-sq": "1,991.36 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Namerou",
...
tokyo = {
    ...
    "density-sq": f"{tokyo_density_sq}",
    "area": "2,194.07 km2",
    "area-sq": "847.14 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Monja Yaki",
...
kanagawa = {
    ...
    "density-sq": f"{kanagawa_density_sq}",
    "area": "2,415.83 km2",
    "area-sq": "932.76 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "Kaigun Kare",
    "industries": ['Chemical', 'Metallurgical', 'Transport', 'Electrical', 'Food industries'],
    "name-kanji": "神奈川県",
    "capital-kanji": "横浜市",
    "iso": "JP-14",
    "area-code": "045"
...
niigata = {
    ...
    "density-sq": f"{niigata_density_sq}",
    "area": "12,584.18 km2",
    "area-sq": "4,858.78 sq mi",
    "climate": "Humid subtropical",
    "local-dish": "SasaDango",
    "industries": ['Agriculture', 'Forestry', 'Fishing', 'Mining', 'Manufacturing'],
    "name-kanji": "新潟県",
    "capital-kanji": "新潟市",
    "iso": "JP-15",
    "area-code": "25",
