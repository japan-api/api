...
raw_sa_pop = saitama_soup.find_all('td')[15].find_all(text=True, recursive=True)
raw_sa_den = saitama_soup.find_all('td')[17].find_all(text=True, recursive=True)
raw_sa_gov = saitama_soup.find_all('td')[12].find_all(text=True, recursive=True)
raw_sa_ar = saitama_soup.find_all('td')[14].find_all(text=True, recursive=True)
raw_sa_pr = saitama_soup.find_all('td')[16].find_all(text=True, recursive=True)
...
raw_ai_pop = aichi_soup.find_all('td')[16].find_all(text=True, recursive=True)
raw_ai_den = aichi_soup.find_all('td')[18].find_all(text=True, recursive=True)
raw_ai_gov = aichi_soup.find_all('td')[13].find_all(text=True, recursive=True)
raw_ai_ar = aichi_soup.find_all('td')[15].find_all(text=True, recursive=True)
raw_ai_pr = aichi_soup.find_all('td')[17].find_all(text=True, recursive=True)
...
raw_os_pop = osaka_soup.find_all('td')[15].find_all(text=True, recursive=True)
raw_os_den = osaka_soup.find_all('td')[17].find_all(text=True, recursive=True)
raw_os_gov = osaka_soup.find_all('td')[12].find_all(text=True, recursive=True)
raw_os_ar = osaka_soup.find_all('td')[14].find_all(text=True, recursive=True)
raw_os_pr = osaka_soup.find_all('td')[16].find_all(text=True, recursive=True)
